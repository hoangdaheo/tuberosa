...
This project is indexed by GitNexus as **tuberosa** (7116 symbols, 15554 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
