...
This project is indexed by GitNexus as **tuberosa** (9920 symbols, 21787 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
