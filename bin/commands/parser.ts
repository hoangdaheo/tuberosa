...
export function usage(): string {
  return [
    ...
    '',
    'Commands:',
    '  init      Bootstrap a project-local Tuberosa stack (Docker if present, embedded fallback otherwise). Add --with-skills to copy bundled agent skills into .claude/skills/.',
