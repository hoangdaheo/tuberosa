...
export function usage(): string {
  return [
    ...
    '',
    'Commands:',
    '  init      Bootstrap the full local stack: Docker Postgres + Redis, migrations, local embedding model. Hard-fails without Docker (use --embedded for volatile trial mode). Add --with-skills to copy bundled agent skills into .claude/skills/.',
