...
- [ ] **Step 6: Implement `syncAtomLinks` helper**
...
- [ ] **Step 3: Implement `inferSemanticNeighbors`**
...
- [ ] **Step 4: Hook into `AtomCritic` (post-accept path)**
...
- [ ] **Step 3: Implement `inferCoChangeLinks`**
...
- [ ] **Step 3: Schedule the job in the worker**
...
- [ ] **Step 3: Update `migrateLegacyKnowledge` to emit `supersedes`**
...
- [ ] **Step 2: Implement `pruneStaleEdges`**
...
- [ ] **Step 4: Add npm script + worker schedule**
